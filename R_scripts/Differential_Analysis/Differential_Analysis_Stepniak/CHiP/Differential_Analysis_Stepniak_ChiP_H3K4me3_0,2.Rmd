---
title: "Differential_Analysis_Stepniak_ChiP_H3K4me3_0,2"
author: "Alizée LANON"
date: "2024-05-06"
...
#--> Phenotypic matrix 
pdata <- read.csv("pdata/pdata_chip_H3K4me3.csv", sep =";", header = TRUE)
#pdata <- pdata[-6,]
row.names(pdata) <- pdata$Sample

#--> Count matrix
# /shared/projects/gliomep53/Scripts_R/Differential_Analysis_Stepniak/CHiP/
mrna_raw_counts <- read.delim(file = "../../../../../Glioma/Stepniak/ChiPseq/Count_matrix/H3K4me3.consensus_peaks.featureCounts.txt", header = TRUE, sep = "\t")
...
#--> Feature annotation
#--> Feature annotation
mrna_gene <- read.table("../../../../../Glioma/Stepniak/ChiPseq/Count_matrix/H3K4me3.consensus_peaks.featureCounts.txt", header = TRUE)[,c(1)]
```
### Filter 
...
#write.table(sorted_genes_df_top, "../../../Integrative_Analysis/Data/5000_loci_logFC_H3K4me3_Stepniak.csv", row.names = FALSE)
```
...
#write.table(counts_mrna,"../../../Integrative_Analysis/Data/counts_ChIP_H3K4me3_Stepniak_norm.csv", row.names = TRUE)
...
```
### Peak Annotation
Peak annotation is the step where for each loci we attribute the name of a gene. Several methods exists but here we used the nearest gene method.
...
#write.table(genes_upreg, "genes_upreg_H3K4me3_.csv", row.names = FALSE)
#write.table(genes_downreg, "genes_downreg_H3K4me3.csv", row.names = FALSE)
#write.table(metabo_up, "genes_metabo_upreg_H3K4me3.csv", row.names = FALSE)
#write.table(metabo_down, "genes_metabo_downreg_H3K4me3.csv", row.names = FALSE)

```
### Comparison with differential analysis
We compared the results obtained with differential analysis results
```{r, message=FALSE}
...
#write.table(enrichment_table_up$`GO Molecular Function`, "Enrich_table_GO_H3K4me3/enrichment_table_up_H3K4me3_GO_molecular_function.csv", row.names = FALSE, sep = ";" )
#write.table(enrichment_table_up$`GO Biological Process`, "Enrich_table_GO_H3K4me3/enrichment_table_up_H3K4me3_GO_biological_process.csv", row.names = FALSE, sep =";")
#write.table(enrichment_table_up$`GO Cellular Component`, "Enrich_table_GO_H3K4me3/enrichment_table_up_H3K4me3_GO_cellular_component.csv", row.names = FALSE, sep =";" )
...
#write.table(enrichment_table_down$`GO Molecular Function`, "Enrich_table_GO_H3K4me3/enrichment_table_down_H3K4me3_GO_molecular_function.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_down$`GO Biological Process`, "Enrich_table_GO_H3K4me3/enrichment_table_down_H3K4me3_GO_biological_process.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_down$`GO Cellular Component`, "Enrich_table_GO_H3K4me3/enrichment_table_down_H3K4me3_GO_cellular_component.csv", row.names = FALSE, sep =";" )
