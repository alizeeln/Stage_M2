---
title: "Differential_Analysis_Stepniak_ChiP_H3K27me3_0,2"
author: "Alizée LANON"
date: "2024-05-06"
...
#--> Phenotypic matrix 
pdata <- read.csv("pdata/pdata_chip_H3K27me3.csv", sep =";", header = TRUE)
row.names(pdata) <- pdata$Sample

#--> Count matrix
mrna_raw_counts <- read.delim(file = "../../../../../Glioma/Stepniak/ChiPseq/Count_matrix/H3K27me3.consensus_peaks.featureCounts.txt", header = TRUE, sep = "\t")
row.names(mrna_raw_counts) <- mrna_raw_counts$Geneid
mrna_raw_counts_table <- mrna_raw_counts[,c(7,8,9,11,13,14)]
...
#--> Feature annotation
mrna_gene <- read.table("../../../../../Glioma/Stepniak/ChiPseq/Count_matrix/H3K27me3.consensus_peaks.featureCounts.txt", header = TRUE)[,c(1)]
```
### Filter 
...
#write.table(sorted_genes_df_top, "../../../Integrative_Analysis/Data/5000_peaks_logFC_H3K27me3_Stepniak.csv", row.names = FALSE)
```
...
#write.table(counts_mrna,"../../../Integrative_Analysis/Data/counts_ChIP_H3K27me3_Stepniak_norm.csv", row.names = TRUE)
...
ens_t_id_up <- macs_peak_ensembl_upreg$feature

ens_t_id_down <- macs_peak_ensembl_downreg$feature

# Retrieve gene IDs and gene names for the given transcript IDs
...
intersect(genes_H3K4me3up_H3K27acdown, metabo_genes)
intersect(genes_H3K4me3down_H3K27acup, metabo_genes)
```
...
#write.table(enrichment_table_up$`GO Molecular Function`, "Enrich_table_GO_H3K27me3/enrichment_table_up_H3K27me3_GO_molecular_function.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_up$`GO Biological Process`, "Enrich_table_GO_H3K27me3/enrichment_table_up_H3K27me3_GO_biological_process.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_up$`GO Cellular Component`, "Enrich_table_GO_H3K27me3/enrichment_table_up_H3K27me3_GO_cellular_component.csv", row.names = FALSE, sep =";" )

######## DOWN
filtered_gr_downreg <- gr_downreg[!grepl("^GL", as.character(seqnames(gr_downreg)))]
gr_downreg <- filtered_gr_downreg
...
#write.table(enrichment_table_down$`GO Molecular Function`, "Enrich_table_GO_H3K27me3/enrichment_table_down_H3K27me3_GO_molecular_function.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_down$`GO Biological Process`, "Enrich_table_GO_H3K27me3/enrichment_table_down_H3K27me3_GO_biological_process.csv", row.names = FALSE, sep =";" )
#write.table(enrichment_table_down$`GO Cellular Component`, "Enrich_table_GO_H3K27me3/enrichment_table_down_H3K27me3_GO_cellular_component.csv", row.names = FALSE, sep =";" )
