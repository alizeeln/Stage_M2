---
title: "Differential_Analysis_Stepniak_ChiP_H3K27ac_0,1"
author: "Alizée LANON"
date: "2024-05-06"
...
pdata <- read.csv("pdata_chip_H3K27ac.csv", sep =";", header = TRUE)
#pdata <- pdata[-6,]
row.names(pdata) <- pdata$Sample

#--> Count matrix
# /shared/projects/gliomep53/Scripts_R/Differential_Analysis_Stepniak/CHiP/
mrna_raw_counts <- read.delim(file = "H3K27ac.consensus_peaks.featureCounts.txt", header = TRUE, sep = "\t")
...
#--> Feature annotation
mrna_gene <- read.table("H3K27ac.consensus_peaks.featureCounts.txt", header = TRUE)[,c(1)]
```
####### Filter ######
```{r, message=FALSE}
